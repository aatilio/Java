...
public class Principal {
    ...
    private static void cargarFabrica(Fabrica f) {
        ...
        s1.agregarInstrumento(new vehiculos("ABC123", 13214, TipoInstrumento.CUERDA));
        s1.agregarInstrumento(new vehiculos("BCD456", 13432, TipoInstrumento.VIENTO));
        s1.agregarInstrumento(new vehiculos("DEF567", 15464, TipoInstrumento.PERCUSION));

        s2.agregarInstrumento(new vehiculos("ASD353", 52432, TipoInstrumento.CUERDA));
        s2.agregarInstrumento(new vehiculos("VXCBE2", 45645, TipoInstrumento.VIENTO));
